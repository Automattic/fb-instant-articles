	...
	function authors( $authors, $iap ) {
		if ( function_exists( 'get_coauthors' ) ) {
			...
			foreach( $coauthors as $coauthor ) {
				...
				$author->first_name    = is_a( $coauthor, 'WP_User' ) ? $coauthor->data->first_name    : $coauthor->first_name;
				$author->last_name     = is_a( $coauthor, 'WP_User' ) ? $coauthor->data->last_name     : $coauthor->last_name;
