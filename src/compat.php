...
if ( function_exists( 'get_coauthors' ) && ! defined( 'CAP_IA_COMPAT' ) ) {
	require __DIR__ . '/compat/class-instant-articles-co-authors-plus.php';
...
if ( defined( 'WPSEO_VERSION' ) && ! defined( 'WPSEO_IA_COMPAT' ) ) {
	require __DIR__ . '/compat/class-instant-articles-yoast-seo.php';
...
if ( ( defined( 'GAWP_VERSION' ) || function_exists( 'MonsterInsights' ) ) && ! defined( 'GAWP_IA_COMPAT' ) ) {
	require __DIR__ . '/compat/class-instant-articles-google-analytics-for-wordpress.php';
...
if ( defined( 'GTM4WP_VERSION' ) ) {
  require __DIR__ . '/compat/class-instant-articles-gtm4wp.php';
...
if ( defined( 'JETPACK__VERSION' ) ) {
	require __DIR__ . '/compat/class-instant-articles-jetpack.php';
...
if ( function_exists( 'get_the_image' ) ) {
	require __DIR__ . '/compat/class-instant-articles-get-the-image.php';
	$gti = new Instant_Articles_Get_The_Image;
	$gti->init();
}

// Load support for Playbuzz plugin by default #515
require __DIR__ . '/compat/class-instant-articles-playbuzz.php';
$playbuzz = new Instant_Articles_Playbuzz;
$playbuzz->init();

// Load support for Apester's plugin Medias
require __DIR__ . '/compat/class-instant-articles-apester.php';
$apester = new Instant_Articles_Apester;
$apester->init();

// Load support for Comscore
require __DIR__ . '/compat/class-instant-articles-comscore.php';
